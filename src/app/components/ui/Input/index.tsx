...
const InputStyle = tv({
	...
	variants: {
		format: {
			normal: "text-neutral-700 bg-neutral-100 border-neutral-200 hover:bg-neutral-200 border",
            error: "text-white bg-neutral-800 border-neutral-700 hover:bg-neutral-700 border"
		},
	},
	defaultVariants: {
		format: "normal",
